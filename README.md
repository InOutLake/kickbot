...
This is where things get tricky. At first, I was surprised there’s no reCAPTCHA on the platform—but later I learned Kick uses the **Kasada** bot defense system. I found a helpful [paper](https://ru.scribd.com/document/899949744/Understanding-Kasada-Bot-Defense-and-Bypass-Mechanisms) on how it works. I also discovered some tools addressing the account-generation problem, such as [this Kick.com account generator](https://github.com/fqw3/Kick.com-account-generator) and various [Kick bot projects](https://github.com/topics/kick-bot).  
...
I also mapped all the features into a diagram:
![Feature diagram](KickBot/files/features.png)
...
### First Iteration  
![Architecture diagram](KickBot/files/SystemDesign_0.png)
Core entities:
...
The diagram is fairly self-explanatory, so I won’t over-explain it here.

Architecture is not elegant at all and very abstract, but that is fine for first iteration. Changes as implementation and research reveals real-world constraints are expected.
